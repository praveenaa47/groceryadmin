...
export const addMainCategories = async (categoryData) => {
  try {
    const response = await axios.post(
      `${API_ENDPOINTS.MAINCATEGORY}/create`,
      categoryData,
      {
        headers: {
...
export const editMainCategories = async (id, reqBody, formData) => {
  try {
    const response = await axios.patch(
      `${API_ENDPOINTS.MAINCATEGORY}/update/${id}`,
      reqBody,
      formData,
      {
        headers: {
...
export const deleteMainCategories = async (id) => {
  try {
    const response = await axios.delete(
      `${API_ENDPOINTS.MAINCATEGORY}/delete/${id}`
    );
    return response.data;
  } catch (error) {
    console.error("Error fetching referral points:", error);
...
export const getbyCatid = async (id) => {
  try {
    const response = await axios.get(
      `${API_ENDPOINTS.CATEGORY}/get/category/${id}`,
      {}
    );
    return response.data;
  } catch (error) {
...
export const addSubCategory = async (reqBody) => {
  try {
    const response = await axios.post(
      `${API_ENDPOINTS.SUBCATEGORY}/create`,
      reqBody,
      {
        headers: {
          "Content-Type": "multipart/form-data",
...
export const deleteSubCategory = async (id) => {
  try {
    const response = await axios.delete(
      `${API_ENDPOINTS.SUBCATEGORY}/delete/${id}`
    );
    return response.data;
  } catch (error) {
    console.error("Error fetching referral points:", error);
